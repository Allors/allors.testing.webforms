// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HtmlButtonTest.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms.Tests
{
    ...
    [WebformsTest("HtmlButtonPage.aspx")]
    public class HtmlButtonTest : WebformsTest<HtmlButtonPage>
    {
        [PreRender(1)]
        public void FillInTextBoxAndPressClick()
        {
            ...
            var button = this.MyPage.Select<HtmlButton>("HtmlButton");
