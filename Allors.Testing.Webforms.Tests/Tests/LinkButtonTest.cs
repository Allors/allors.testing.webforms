// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinkButtonTest.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms.Tests
{
    ...
    [WebformsTest("LinkButtonPage.aspx")]
    public class LinkButtonTest : WebformsTest<LinkButtonPage>
    {
        [PreRender(1)]
        public void FillInTextBoxAndPressClick()
        {
            ...
            this.Browser.Click(this.MyPage.Select<LinkButton>("LinkButton"));
        }
