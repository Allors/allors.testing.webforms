// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostUpdateRequestCacheAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostUpdateRequestCacheAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostUpdateRequestCacheAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostUpdateRequestCache; }
        }
    }
}