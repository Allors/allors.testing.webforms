// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReleaseRequestStateAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class ReleaseRequestStateAttribute : ApplicationLifeCycleEventAttribute
    {
        public ReleaseRequestStateAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.ReleaseRequestState; }
        }
    }
}