// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BeginRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class BeginRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public BeginRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.BeginRequest; }
        }
    }
}