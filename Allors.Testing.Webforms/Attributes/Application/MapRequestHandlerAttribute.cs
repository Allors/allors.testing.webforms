// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MapRequestHandlerAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class MapRequestHandlerAttribute : ApplicationLifeCycleEventAttribute
    {
        public MapRequestHandlerAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.MapRequestHandler; }
        }
    }
}