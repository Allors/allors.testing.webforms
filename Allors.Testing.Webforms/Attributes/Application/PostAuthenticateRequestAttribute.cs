// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostAuthenticateRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostAuthenticateRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostAuthenticateRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostAuthenticateRequest; }
        }
    }
}