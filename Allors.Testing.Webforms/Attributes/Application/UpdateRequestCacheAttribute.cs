// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UpdateRequestCacheAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class UpdateRequestCacheAttribute : ApplicationLifeCycleEventAttribute
    {
        public UpdateRequestCacheAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.UpdateRequestCache; }
        }
    }
}