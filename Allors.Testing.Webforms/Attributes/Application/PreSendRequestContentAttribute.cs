// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PreSendRequestContentAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PreSendRequestContentAttribute : ApplicationLifeCycleEventAttribute
    {
        public PreSendRequestContentAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PreSendRequestContent; }
        }
    }
}