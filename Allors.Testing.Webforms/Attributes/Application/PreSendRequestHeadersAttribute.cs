// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PreSendRequestHeadersAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PreSendRequestHeadersAttribute : ApplicationLifeCycleEventAttribute
    {
        public PreSendRequestHeadersAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PreSendRequestHeaders; }
        }
    }
}