// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostAuthorizeRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostAuthorizeRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostAuthorizeRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostAuthorizeRequest; }
        }
    }
}