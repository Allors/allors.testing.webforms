// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResolveRequestCacheAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class ResolveRequestCacheAttribute : ApplicationLifeCycleEventAttribute
    {
        public ResolveRequestCacheAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.ResolveRequestCache; }
        }
    }
}