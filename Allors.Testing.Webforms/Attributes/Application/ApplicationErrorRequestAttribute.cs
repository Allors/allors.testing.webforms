// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ApplicationErrorRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class ApplicationErrorAttribute : ApplicationLifeCycleEventAttribute
    {
        public ApplicationErrorAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.Error; }
        }
    }
}