// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostResolveRequestCacheAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostResolveRequestCacheAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostResolveRequestCacheAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostResolveRequestCache; }
        }
    }
}