// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EndRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class EndRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public EndRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.EndRequest; }
        }
    }
}