// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LogRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class LogRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public LogRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.LogRequest; }
        }
    }
}