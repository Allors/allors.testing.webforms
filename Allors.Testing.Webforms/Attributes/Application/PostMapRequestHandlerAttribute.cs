// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostMapRequestHandlerAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostMapRequestHandlerAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostMapRequestHandlerAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostMapRequestHandler; }
        }
    }
}