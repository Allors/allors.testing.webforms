// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AuthenticateRequestAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class AuthenticateRequestAttribute : ApplicationLifeCycleEventAttribute
    {
        public AuthenticateRequestAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.AuthenticateRequest; }
        }
    }
}