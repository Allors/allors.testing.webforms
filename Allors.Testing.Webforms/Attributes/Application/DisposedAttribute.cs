// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DisposedAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class DisposedAttribute : ApplicationLifeCycleEventAttribute
    {
        public DisposedAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.Disposed; }
        }
    }
}