// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostAcquireRequestStateAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostAcquireRequestStateAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostAcquireRequestStateAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostAcquireRequestState; }
        }
    }
}