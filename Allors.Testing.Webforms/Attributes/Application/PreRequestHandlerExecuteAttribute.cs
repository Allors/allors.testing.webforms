// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PreRequestHandlerExecuteAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PreRequestHandlerExecuteAttribute : ApplicationLifeCycleEventAttribute
    {
        public PreRequestHandlerExecuteAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PreRequestHandlerExecute; }
        }
    }
}