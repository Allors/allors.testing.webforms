// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AcquireRequestStateAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class AcquireRequestStateAttribute : ApplicationLifeCycleEventAttribute
    {
        public AcquireRequestStateAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.AcquireRequestState; }
        }
    }
}