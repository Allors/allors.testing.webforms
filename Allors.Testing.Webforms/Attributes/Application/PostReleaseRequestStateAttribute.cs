// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PostReleaseRequestStateAttribute.cs" company="allors bvba">
...
namespace Allors.Testing.Webforms
{
    ...
    public class PostReleaseRequestStateAttribute : ApplicationLifeCycleEventAttribute
    {
        public PostReleaseRequestStateAttribute(int requestCount)
            : base(requestCount)
        {
        }
        ...
        {
            get { return ApplicationLifeCycleEvent.PostReleaseRequestState; }
        }
    }
}